...
export default function Card({ note, className }) {
  return (
    <div
      className={twMerge(
    ...
    >
      ...
      <button className="absolute right-0 top-0 flex aspect-square w-8 cursor-pointer items-center justify-center p-2 text-danger-500 hover:text-danger-400">
